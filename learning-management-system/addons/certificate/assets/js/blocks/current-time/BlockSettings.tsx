...
const BlockSettings: React.FC<any> = (props) => {
	const {
		attributes: { alignment, textColor, fontSize, timeFormat = 'g:i a' },
		setAttributes,
	} = props;
	...
	return (
		<InspectorControls>
			<Panel title={__('Text', 'learning-management-system')} initialOpen>
				<Select
					value={timeFormat}
					label={__('Time Format', 'learning-management-system')}
					options={[
						{ label: '12:34 PM', value: 'g:i A' },
						{ label: '12:34:56', value: 'H:i:s' },
						{ label: '12:34', value: 'H:i' },
					]}
