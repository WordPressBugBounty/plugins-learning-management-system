<?php
/**
 * The Template for displaying single course immersive layout.
 *
 * @version 1.0.0
 */
...
add_filter( 'body_class', 'masteriyo_immersive_layout_body_class' );
...
if ( $enable_custom_template && $template_source && $template_id ) {
	...
	masteriyo_get_template_part( 'content', 'single-course-immersive' );
