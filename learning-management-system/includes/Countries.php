...
class Countries {
	...
	public function shipping_to_prefix( $country_code = '' ) {
		...
		$return       = in_array( $country_code, $countries, true ) ? __( 'to the', 'learning-management-system' ) : __( 'to', 'learning-management-system' );
	...
	public function estimated_for_prefix( $country_code = '' ) {
		...
		$countries    = array( 'GB', 'US', 'AE', 'CZ', 'DO', 'NL', 'PH', 'USAF' );
		$return       = in_array( $country_code, $countries, true ) ? __( 'the', 'learning-management-system' ) . ' ' : '';
	...
	public function tax_or_vat() {
		$return = in_array( $this->get_base_country(), $this->get_vat_countries(), true ) ? __( 'VAT', 'learning-management-system' ) : __( 'Tax', 'learning-management-system' );
	...
	public function inc_tax_or_vat() {
		$return = in_array( $this->get_base_country(), $this->get_vat_countries(), true ) ? __( '(incl. VAT)', 'learning-management-system' ) : __( '(incl. tax)', 'learning-management-system' );
	...
	public function ex_tax_or_vat() {
		$return = in_array( $this->get_base_country(), $this->get_vat_countries(), true ) ? __( '(ex. VAT)', 'learning-management-system' ) : __( '(ex. tax)', 'learning-management-system' );
	...
	public function get_default_address_fields() {
		$fields = array(
			...
			'email'      => array(
				'label'        => __( 'Email address', 'learning-management-system' ),
				'enable'       => true,
				'required'     => true,
				'type'         => 'email',
			...
			'phone'      => array(
				'label'        => __( 'Phone Number', 'learning-management-system' ),
				'required'     => true,
				'type'         => 'tel',
				'class'        => array( 'form-row-wide' ),
			...
			'city'       => array(
				'label'        => __( 'City', 'learning-management-system' ),
				'required'     => true,
				'type'         => 'text',
				'class'        => array( 'form-row-wide' ),
				'validate'     => array( 'city' ),
			...
			'state'      => array(
				'label'        => __( 'State', 'learning-management-system' ),
				'required'     => true,
				'type'         => 'text',
				'class'        => array( 'form-row-wide' ),
			...
			'postcode'   => array(
				'label'        => __( 'Postal Code', 'learning-management-system' ),
				'required'     => true,
				'type'         => 'text',
				'class'        => array( 'form-row-wide' ),
			...
			'address_1'  => array(
				'label'        => __( 'Address 1', 'learning-management-system' ),
				'required'     => true,
				'type'         => 'text',
				'class'        => array( 'form-row-wide' ),
			...
			'address_2'  => array(
				'label'        => __( 'Address 2', 'learning-management-system' ),
				'required'     => false,
				'type'         => 'text',
				'class'        => array( 'form-row-wide' ),
			...
			'country'    => array(
				'label'        => __( 'Country', 'learning-management-system' ),
				'required'     => true,
				'type'         => 'text',
				'class'        => array( 'form-row-wide' ),
		...
		$this->locale = apply_filters(
			...
			array(
				...
				'AO' => array(
					...
					'state'    => array(
						'label' => __( 'Province', 'learning-management-system' ),
					),
				),
				'AT' => array(
					'postcode' => array(
				...
				'AU' => array(
					'city'     => array(
						'label' => __( 'Suburb', 'learning-management-system' ),
					),
					'postcode' => array(
						'label' => __( 'Postcode', 'learning-management-system' ),
					),
					'state'    => array(
						'label' => __( 'State', 'learning-management-system' ),
					),
				...
				'BA' => array(
					...
					'state'    => array(
						'label'    => __( 'Canton', 'learning-management-system' ),
						'required' => false,
						'hidden'   => true,
					),
				),
				'BD' => array(
					...
					'state'    => array(
						'label' => __( 'District', 'learning-management-system' ),
					),
				),
				'BE' => array(
					'postcode' => array(
				...
				'CL' => array(
					...
					'state'    => array(
						'label' => __( 'Region', 'learning-management-system' ),
					),
				),
				'CN' => array(
					'state' => array(
				...
				'GT' => array(
					...
					'state'    => array(
						'label' => __( 'Department', 'learning-management-system' ),
					),
				),
				'HK' => array(
					'postcode' => array(
					...
					'city'     => array(
						'label' => __( 'Town / District', 'learning-management-system' ),
					),
					'state'    => array(
						'label' => __( 'Region', 'learning-management-system' ),
					),
				...
				'HU' => array(
					...
					'state'      => array(
						'label' => __( 'County', 'learning-management-system' ),
					),
				),
				'ID' => array(
					'state' => array(
				...
				'IE' => array(
					'postcode' => array(
						'required' => false,
						'label'    => __( 'Eircode', 'learning-management-system' ),
					),
					'state'    => array(
						'label' => __( 'County', 'learning-management-system' ),
					),
				...
				'IN' => array(
					'postcode' => array(
						'label' => __( 'Pin code', 'learning-management-system' ),
					),
					'state'    => array(
						'label' => __( 'State', 'learning-management-system' ),
					),
				...
				'JM' => array(
					'city'     => array(
						'label' => __( 'Town / City / Post Office', 'learning-management-system' ),
					),
					'postcode' => array(
						'required' => false,
						'label'    => __( 'Postal Code', 'learning-management-system' ),
					...
					'state'    => array(
						'required' => true,
						'label'    => __( 'Parish', 'learning-management-system' ),
					),
				),
				'JP' => array(
					'last_name'  => array(
					...
					'state'      => array(
						'label'    => __( 'Prefecture', 'learning-management-system' ),
						'class'    => array( 'form-row-last', 'address-field' ),
						'priority' => 66,
					),
					'city'       => array(
				...
				'LV' => array(
					'state' => array(
						'label'    => __( 'Municipality', 'learning-management-system' ),
						'required' => false,
					),
				),
				'LB' => array(
				...
				'NP' => array(
					'state'    => array(
						'label' => __( 'State / Zone', 'learning-management-system' ),
					),
					'postcode' => array(
						'required' => false,
					),
				...
				'MD' => array(
					'state' => array(
						'label' => __( 'Municipality / District', 'learning-management-system' ),
					),
				),
				'SE' => array(
					'postcode' => array(
				...
				'UG' => array(
					...
					'city'     => array(
						'label'    => __( 'Town / Village', 'learning-management-system' ),
						'required' => true,
					),
					'state'    => array(
						'label'    => __( 'District', 'learning-management-system' ),
				...
				'US' => array(
					'postcode' => array(
						'label' => __( 'ZIP', 'learning-management-system' ),
					),
					'state'    => array(
						'label' => __( 'State', 'learning-management-system' ),
					),
