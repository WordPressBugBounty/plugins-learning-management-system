...
class OnHoldOrderEmailToStudent extends Email {
	...
	public function trigger( $order ) {
		...
		$to_addresses_setting = masteriyo_get_setting( 'emails.student.onhold_order.to_address' );
		$to_address           = array();
	...
	public function get_subject() {
		...
		$subject = empty( $subject ) ? masteriyo_get_default_email_contents()['student']['onhold_order']['subject'] : $subject;
	...
	public function get_content() {
		$content = masteriyo_string_translation( 'emails.student.onhold_order.content', 'masteriyo-email-message', masteriyo_get_setting( 'emails.student.onhold_order.content' ) );
	...
	public function get_reply_to_name() {
		 ...
		 */
		$reply_to_name = apply_filters( $this->get_full_id() . 'reply_to_name', masteriyo_get_setting( 'emails.student.onhold_order.reply_to_name' ) );
	...
	public function get_reply_to_address( $reply_to_address = '' ) {
		 ...
		 */
		$reply_to_address = apply_filters( $this->get_full_id() . 'reply_to_address', masteriyo_get_setting( 'emails.student.onhold_order.reply_to_address' ) );
	...
	public function get_from_name() {
		 ...
		 */
		$from_name = apply_filters( $this->get_full_id() . '_from_name', masteriyo_get_setting( 'emails.student.onhold_order.from_name' ) );
	...
	public function get_from_address( $from_address = '' ) {
		 ...
		 */
		$from_address = apply_filters( $this->get_full_id() . '_from_address', masteriyo_get_setting( 'emails.student.onhold_order.from_address' ) );
