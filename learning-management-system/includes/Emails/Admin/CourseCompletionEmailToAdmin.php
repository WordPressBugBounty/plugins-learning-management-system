...
class CourseCompletionEmailToAdmin extends Email {
	 ...
	 * @var string
	 */
	protected $id = 'course-completion/to/admin';
	 ...
	 * @var string
	 */
	protected $html_template = 'emails/admin/course-completion.php';
	...
	public function trigger( $course_progress ) {
		...
		$to_address = explode( ',', $this->format_string( masteriyo_get_setting( 'emails.admin.course_completion.to_address' ) ) ?? $admin_email );
	...
	public function is_enabled() {
		return masteriyo_string_to_bool( masteriyo_get_setting( 'emails.admin.course_completion.enable' ) );
	}
	...
	public function get_subject() {
		 ...
		 */
		$subject = apply_filters( $this->get_full_id(), masteriyo_get_setting( 'emails.admin.course_completion.subject' ) );
		$subject = is_string( $subject ) ? trim( $subject ) : '';
		$subject = empty( $subject ) ? masteriyo_get_default_email_contents()['admin']['course_completion']['subject'] : $subject;
	...
	public function get_heading() {
		 ...
		 */
		$heading = apply_filters( $this->get_full_id() . '_heading', masteriyo_get_setting( 'emails.admin.course_completion.heading' ) );
	...
	public function get_content() {
		$content = masteriyo_string_translation( 'emails.admin.course_completion.content', 'masteriyo-email-message', masteriyo_get_setting( 'emails.admin.course_completion.content' ) );
	...
	public function get_reply_to_name() {
		 ...
		 */
		$reply_to_name = apply_filters( $this->get_full_id() . 'reply_to_name', masteriyo_get_setting( 'emails.admin.course_completion.reply_to_name' ) );
	...
	public function get_reply_to_address( $reply_to_address = '' ) {
		 ...
		 */
		$reply_to_address = apply_filters( $this->get_full_id() . 'reply_to_address', masteriyo_get_setting( 'emails.admin.course_completion.reply_to_address' ) );
	...
	public function get_from_name() {
		 ...
		 */
		$from_name = apply_filters( $this->get_full_id() . '_from_name', masteriyo_get_setting( 'emails.admin.course_completion.from_name' ) );
	...
	public function get_from_address( $from_address = '' ) {
		 ...
		 */
		$from_address = apply_filters( $this->get_full_id() . '_from_address', masteriyo_get_setting( 'emails.admin.course_completion.from_address' ) );
