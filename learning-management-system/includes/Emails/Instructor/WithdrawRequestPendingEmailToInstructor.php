...
class WithdrawRequestPendingEmailToInstructor extends Email {
	 ...
	 * @var string
	 */
	protected $id = 'withdraw-request-pending/to/instructor';
	...
	public function get_additional_content() {
		...
		$additional_content = masteriyo_string_translation( 'emails.instructor.withdraw_request_pending.additional_content', 'masteriyo-email-message', $additional_content );
	...
	public function get_content() {
		$content = masteriyo_string_translation( 'emails.instructor.withdraw_request_pending.content', 'masteriyo-email-message', masteriyo_get_setting( 'emails.instructor.withdraw_request_pending.content' ) );
	...
	public function get_reply_to_name() {
		 ...
		 */
		$reply_to_name = apply_filters( $this->get_full_id() . 'reply_to_name', masteriyo_get_setting( 'emails.instructor.withdraw_request_pending.reply_to_name' ) );
	...
	public function get_reply_to_address( $reply_to_address = '' ) {
		 ...
		 */
		$reply_to_address = apply_filters( $this->get_full_id() . 'reply_to_address', masteriyo_get_setting( 'emails.instructor.withdraw_request_pending.reply_to_address' ) );
	...
	public function get_from_name() {
		 ...
		 */
		$from_name = apply_filters( $this->get_full_id() . '_from_name', masteriyo_get_setting( 'emails.instructor.withdraw_request_pending.from_name' ) );
	...
	public function get_from_address( $from_address = '' ) {
		 ...
		 */
		$from_address = apply_filters( $this->get_full_id() . '_from_address', masteriyo_get_setting( 'emails.instructor.withdraw_request_pending.from_address' ) );
