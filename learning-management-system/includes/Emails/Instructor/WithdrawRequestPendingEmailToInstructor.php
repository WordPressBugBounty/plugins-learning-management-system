...
class WithdrawRequestPendingEmailToInstructor extends Email {
	...
	public function get_subject() {
		$subject = masteriyo_get_default_email_contents()['instructor']['withdraw_request_pending']['subject'];
	...
	public function get_content() {
		$content = masteriyo_string_translation( 'emails.instructor.withdraw_request_pending.content', 'masteriyo-email-message', masteriyo_get_default_email_contents()['instructor']['withdraw_request_pending']['content'] );
